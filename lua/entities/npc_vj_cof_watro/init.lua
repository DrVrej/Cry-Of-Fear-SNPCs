...
-----------------------------------------------*/
ENT.Model = {"models/cryoffear/watro/watro.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
ENT.NextAnyAttackTime_Melee = 1.4 -- How much time until it can use any attack again? | Counted in Seconds
