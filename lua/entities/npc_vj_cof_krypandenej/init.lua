...
-----------------------------------------------*/
ENT.Model = {"models/cryoffear/crawler2/krypandenej.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
ENT.NextAnyAttackTime_Melee = 0.434 -- How much time until it can use any attack again? | Counted in Seconds
